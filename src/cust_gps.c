...
#endif
		//DBG("%u %u", gSys.nParam[PARAM_TYPE_LOCAT].Data.LocatInfo.MileageKM, gSys.nParam[PARAM_TYPE_LOCAT].Data.LocatInfo.MileageM);
	}
	Locat_CacheSave();
...
#ifdef __LBS_AUTO__
	if (GPSCtrl.NoLocatCNT >= GPSCtrl.Param[PARAM_GPS_V_TO] / 2)
	{
		GPSCtrl.NoLocatCNT = 0;
		SYS_Error(NO_LOCAT_ERROR, 1);
	}
